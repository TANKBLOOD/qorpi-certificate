...
Route::get('certificate/list', [CertificateController::class, 'index'])->name('certificate.index');
Route::get('certificate/export/{id}', [CertificateController::class, 'exportCertificate'])->name('certificate.export');
Route::get('certificate/download/{id}', [CertificateController::class, 'downloadCert'])->name('certificate.download');
